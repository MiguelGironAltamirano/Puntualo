...
async def list_evaluations(
    ...
    min_clarity: float | None = Query(None, ge=1.0, le=5.0),
    max_clarity: float | None = Query(None, ge=1.0, le=5.0),
    min_easiness: float | None = Query(None, ge=1.0, le=5.0),
    max_easiness: float | None = Query(None, ge=1.0, le=5.0),
    min_helpfulness: float | None = Query(None, ge=1.0, le=5.0),
    max_helpfulness: float | None = Query(None, ge=1.0, le=5.0),
    min_punctuality: float | None = Query(None, ge=1.0, le=5.0),
    max_punctuality: float | None = Query(None, ge=1.0, le=5.0),
