...
import { Search, Lightbulb, Scale, Filter, MapPin, AlignRight } from "lucide-react";
    ...
    <div className="min-h-screen bg-white font-sans flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-1 w-full max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col relative z-10 pt-20 pb-24">
        ...
        <section className="flex flex-col items-center text-center mt-4 mb-24">
          ...
          <div className="w-full max-w-3xl relative">
            ...
            <input 
              type="text" 
              className="w-full h-16 pl-14 pr-32 rounded-full border border-gray-200 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.06)] text-[15px] font-medium focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 transition-all placeholder:text-gray-400"
              placeholder="Busca por docente, materia o facultad..."
            />
            <button className="absolute right-2 top-2 bottom-2 px-8 bg-[#f97316] hover:bg-[#ea580c] text-white font-bold text-sm rounded-full transition-colors">
              Buscar
            </button>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-6">
            {["Cálculo Avanzado", "Ingeniería", "Alta Claridad"].map((tag) => (
              <span key={tag} className="px-4 py-1.5 bg-[#f8fafc] border border-gray-200 rounded-full text-xs font-bold text-[#64748b] shadow-sm hover:border-gray-300 cursor-pointer transition-colors">
                {tag}
              </span>
            ))}
          </div>
        ...
        <section className="flex flex-col items-center mt-12 w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-md transition-shadow flex flex-col">
              ...
              <div className="flex gap-2 mt-auto pb-4">
                <div className="h-2 bg-[#f97316] w-[40%] rounded-full"></div>
          ...
          <div className="bg-white w-full rounded-2xl p-8 border border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-md transition-shadow flex flex-col md:flex-row md:items-center justify-between gap-8">
            ...
            <Link href="/buscador" className="px-6 py-2.5 rounded-full border-2 border-[#bae6fd] text-[#0284c7] font-bold hover:bg-[#f0f9ff] transition-colors whitespace-nowrap text-sm text-center">
              Explorar Buscador
            </Link>
          </div>
        </section>
      ...
      <footer className="w-full bg-[#f8fafc] py-8 mt-12 border-t border-gray-100 relative z-10">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-lg font-extrabold text-[#0369a1] tracking-tight">
            Puntualo
          </div>
          ...
          <div className="text-[13px] text-[#94a3b8] font-medium">
            © 2024 Puntualo EdTech. Todos los derechos reservados.
          </div>
        </div>
      </footer>
    </div>
