                ...
                <div key={comment.id} className="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm space-y-4 text-left">
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <button type="button" onClick={() => setIsReportOpen(true)} className="text-slate-300 hover:text-slate-500 p-0.5 transition-colors cursor-pointer focus:outline-none">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 pt-3.5 border-t border-slate-100 text-[11px] font-bold text-slate-400">
                        <div className="flex items-center gap-3">
                            ...
                            <button type="button" onClick={() => setIsReportOpen(true)} className="flex items-center gap-1 text-[10px] hover:text-red-500 cursor-pointer transition-colors ml-2 font-semibold">
                                Reportar
                            </button>
                        </div>
